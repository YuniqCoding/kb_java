...
import command.command.AnalizeCommand;
import command.command.ExitCommand;
import command.command.GetScoresCommand;
import command.command.InitScoresCommand;
import command.command.PrintScoreCommand;
import ui.Menu;
import ui.MenuItem;
